...
export default function LoginPage() {
  ...
  const handleContinue = () => {
    // Dummy auth - just proceed to onboarding
    navigate('/onboarding');
  };
      ...
      <div className="flex-1 flex items-center justify-center px-8 bg-white">
        <div className="w-full max-w-sm">
          ...
          <p className="text-gray-500 mb-8">
            Sign in or create a new account in one click
          </p>
          ...
          {/* Demo Notice */}
          <div className="mt-8 p-3 bg-amber-50 border border-amber-200 rounded-lg text-center">
            <p className="text-amber-700 text-sm">
              🎭 <span className="font-medium">Demo Mode</span> — No real authentication. Click any button to continue.
            </p>
          </div>
        </div>
      </div>
